...
export default function App() {
  ...
  const navItems = ["Root", "Tech Stack", "Logs", "Mail"];
  const navItemsLocation = ["#", "#core_arch", "#logs", "#contact-me"];
  ...
  const resumelink =
    "https://drive.google.com/file/d/1TDA4ZP6_xelXhojvR2hI9xwk8zIx7YOt/view?usp=drive_link";
  const stats = [
    { label: "Years Experience", value: "2+" },
    { label: "Internal Employees Benefited", value: "5000+" },
    { label: "Uptime Target", value: "99.9%" },
    { label: "Security Cleared", value: "Sr SDE" },
  ];
  ...
  const experience = [
    {
      ...
      description:
        "Optimized automation reliability and internal metrics pipelines, improving SLA compliance by 35%. Worked across backend services and integrations to improve observability.",
    ...
    },
    {
      ...
      company: "ZSCALER | PLATFORM ENGINEERING",
      description:
        "Built a Slackbot integrating Jira and Confluence using Node.js, adopted by 1000+ employees. Automated ticket routing, reducing IT response time by 40%.",
    ...
    },
    {
      ...
      description:
        "Migrated legacy Backbone.js views to React, reducing bundle size. Authored E2E test cases, cutting QA cycles by 30%.",
  ...
  const projects = [
    {
      ...
      description:
        "Scalable video platform supporting background encoding (FFmpeg) and secure playback. Designed a distributed job queue using RabbitMQ.",
      tech: ["SPRING BOOT", "NEXT.JS", "RABBITMQ", "REDIS"],
      icon: <Globe className="text-primary" size={24} />,
      url: "https://bideo.tech/",
    },
    {
      title: "Travel Buddy",
      subtitle: "Ride Sharing Platform",
      description:
        "Campus ride-sharing app with live tracking. Facilitated 100+ rides during campus events with real-time updates.",
      tech: ["REACT", "NODE.JS", "MONGODB"],
      icon: <MapPin className="text-primary" size={24} />,
      url: "https://github.com/rajitk13/TravelBuddy",
    },
  ];
  ...
  const skills = [
    {
      category: "Languages",
      items: ["JavaScript", "TypeScript", "Java", "C++", "Python", "Go", "SQL"],
    },
    {
      category: "Frontend",
      items: ["React", "Next.js", "Tailwind CSS", "Bootstrap", "Backbone.js"],
    },
    {
      category: "Backend",
      items: ["Spring Boot", "Node.js", "Express", "MongoDB", "PostgreSQL"],
    },
    {
  ...
  return (
    <div className="min-h-screen selection:bg-primary selection:text-surface">
        ...
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8 font-headline tracking-tight">
            {navItems.map((item, index) => (
              ...
              >
                <a href={`${navItemsLocation[index]}`}> {item}</a>
              </button>
            ))}
          </div>
      ...
      <main className="pt-24 min-h-screen">
        ...
        <section className="relative px-8 py-20 max-w-screen-2xl mx-auto flex flex-col items-start gap-12">
          ...
          >
            ...
            <p className="font-body text-xl text-on-surface-variant max-w-2xl leading-relaxed mb-10">
              Senior Software Development Engineer specializing in high-scale
              infrastructure and secure backend architectures. Engineering
              resilient systems for the next era of computation.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="bg-surface-container text-on-surface px-8 py-4 rounded-lg font-headline font-bold uppercase tracking-widest text-sm border border-primary/10 hover:bg-surface-container-high transition-all">
                <a href="#contact-me">Connect with me?</a>
              </button>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full border-t border-primary/10 pt-12 mt-12">
            {stats.map((stat, idx) => (
              ...
              >
                ...
                <div className="text-on-surface-variant text-[10px] uppercase tracking-widest mt-1">
                  {stat.label}
                </div>
              </motion.div>
            ))}
        ...
        <section className="px-8 py-24 bg-surface-container-low" id="core_arch">
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              {/* Protocol Stack */}
              <div className="md:col-span-8 bg-surface-container-high p-8 rounded-xl border border-primary/10">
                <h4 className="font-headline text-xs font-bold uppercase tracking-widest mb-8 text-primary">
                  Protocol_Stack
                </h4>
                    ...
                    <div key={skill.category}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skill.items.map((item) => (
                          <span
                            key={item}
                            className="px-2 py-1 bg-surface-container-lowest rounded text-[10px] font-headline text-primary border border-primary/5"
                          >
                            {item}
                          </span>
                        ))}
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="md:col-span-4 bg-surface-container p-8 rounded-xl border border-primary/10 relative overflow-hidden group"
                onClick={() => {
                  handleClick(
                    "https://www.nature.com/articles/s41598-025-91786-3",
                  );
                }}
              >
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    <span className="bg-primary/10 text-primary px-3 py-1 rounded text-[10px] font-headline tracking-widest uppercase mb-6 inline-block">
                    ...
                    <h3 className="font-headline text-3xl font-bold mb-4 group-hover:text-primary transition-colors">
                      A deep ensemble learning approach for squamous cell
                      classification in cervical cancer
                    </h3>
                    <p className="text-on-surface-variant leading-relaxed max-w-xl">
                      The study presents a robust approach to cervical cancer
                      classification using deep learning techniques.The
                      integration of multiple CNN architectures through ensemble
                      learning significantly improves classification accuracy,
                      demonstrating the potential for more reliable and accurate
                      diagnosis.
                    </p>
                  </div>
                  <div className="mt-8 flex items-center gap-4">
                    <span className="text-[10px] font-headline text-on-surface-variant uppercase tracking-widest">
                      Identifier: nature.com/articles/s41598-023
                    </span>
                    <a
                      href="#"
                      className="text-primary flex items-center gap-2 text-sm font-bold uppercase tracking-wider group/link"
                    >
                      Read Journal
                      <ChevronRight
                        size={16}
                ...
                >
                  <div className="bg-surface-container-lowest rounded-xl border border-primary/10 overflow-hidden aspect-video relative">
                    ...
                    <div className="absolute bottom-0 left-0 p-8">
                      ...
                      <h4 className="font-headline text-2xl font-bold mb-2 uppercase tracking-tight">
                        {project.title}
                      </h4>
                      ...
                      <div className="flex gap-2">
                        {project.tech.map((t) => (
                          <span
                            key={t}
                            className="text-[9px] font-headline text-primary/60 border border-primary/20 px-2 py-0.5 rounded"
                          >
                            {t}
                          </span>
                        ))}
        ...
        <section className="px-8 py-24 max-w-screen-2xl mx-auto" id="logs">
          <h2 className="font-headline text-3xl font-bold mb-16 uppercase tracking-widest flex items-center gap-4">
            <span className="w-12 h-[2px] bg-primary" />
            Log_History
          </h2>
          ...
          <div className="space-y-4">
            {experience.map((exp, idx) => (
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="font-headline text-[10px] text-on-surface-variant w-24 tracking-widest">
                    {exp.period}
                  </div>
                  <div>
                    <div className="text-primary font-headline font-bold uppercase tracking-tight">
                      {exp.role}
                    </div>
                    <div className="text-xs text-on-surface-variant font-headline uppercase tracking-widest mb-2">
                      {exp.company}
                    </div>
                    <div className="text-sm text-on-surface-variant max-w-2xl leading-relaxed">
                      {exp.description}
                    </div>
                  </div>
                </div>
                <div className="flex gap-2">
                  {exp.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-1 bg-surface-container-highest rounded text-[9px] font-headline text-on-surface-variant tracking-widest"
                    >
                      {tag}
                    </span>
                  ))}
        ...
        <section className="px-8 py-24 mb-12" id="contact-me">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-surface-container-high to-surface-container p-12 rounded-2xl border border-primary/20 text-center relative overflow-hidden">
            ...
            <p className="text-on-surface-variant mb-10 max-w-lg mx-auto">
              Currently open to new opportunities in Product, Backend, or
              Frontend Engineering. Let's build something resilient.
            </p>
            ...
            <div className="flex justify-center gap-8 mt-12 text-on-surface-variant">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="hover:text-primary transition-colors flex items-center gap-2 text-xs uppercase tracking-widest font-headline"
              >
              ...
              <a
                href="mailto:rajitkuthiala@gmail.com"
                className="hover:text-primary transition-colors flex items-center gap-2 text-xs uppercase tracking-widest font-headline"
              >
                <Mail size={16} /> Mail
              </a>
      ...
      <footer className="w-full border-t border-primary/10 bg-surface">
        <div className="flex flex-col md:flex-row justify-between items-center w-full px-8 py-12 max-w-screen-2xl mx-auto gap-6 font-headline text-[10px] uppercase tracking-[0.2em] text-on-surface-variant">
          <div>© 2026 ARCHITECT_OS // RAJIT_KUTHIALA // BENGALURU, INDIA</div>
